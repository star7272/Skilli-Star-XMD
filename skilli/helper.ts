...
const BOT_NAME = "Skilli Star-XMD";
const DEFAULT_THUMBNAIL = "https://files.catbox.moe/j3xhv4.png";
...
const createContext = (userJid, options = {}) => ({
    contextInfo: {
        ...
        externalAdReply: {
            ...
            sourceUrl: options.sourceUrl || "https://wa.me/254738017513", // link to bot or business
