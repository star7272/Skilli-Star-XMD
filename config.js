// Skilli Star-xmd by Skilli Stars 
...
module.exports = {
    ...
    GURL: 'https://whatsapp.com/channel/0029VbBwdckAe5VjKbsshz42',
    OWNER_NAME: process.env.OWNER_NAME || "Skilli Stars",
    OWNER_NUMBER: process.env.OWNER_NUMBER || "",
    BOT: process.env.BOT_NAME || 'Skilli Stars-XMD',
